...
```{r}
ord_plotlj(readRDS(here("Code/Models/mod_outputs/bird_md_RLGA.Rds")), 
         "RLGA", 
         "Bird") -> p1
ord_plotlj(readRDS(here("Code/Models/mod_outputs/fruit_ms_OPCR.Rds")), 
         "m2_opcr", 
         "Fruit") + 
  labs(y = "", x = "m2 OPCr") -> p2
ord_plotlj(readRDS(here("Code/Models/mod_outputs/herptile_md_DNE.Rds")), 
         "m1_dne", 
         "Herptile") + 
  labs(y = "", x = "m1 aDNE") -> p3
ord_plotlj(readRDS(here("Code/Models/mod_outputs/large_mammal_ms_RLGA.Rds")), 
         "RLGA", 
         "Large Mammal")  -> p4
ord_plotlj(readRDS(here("Code/Models/mod_outputs/small_mammal_md_RLGA.Rds")), 
         "RLGA", 
         "Small Mammal")  + 
  labs(y = "") -> p5
ord_plotlj(readRDS(here("Code/Models/mod_outputs/soft_invert_mn_DNE.Rds")), 
         "m1_dne", 
         "Soft Invertebrate") + 
  labs(y = "", x = "m1 aDNE") -> p6
...
plot3col
ggsave(here("Plots", "Figure_3.pdf"), width = 10, height = 5)
ggsave(here("Plots", "Figure_3.png"), width = 10, height = 5)
```
