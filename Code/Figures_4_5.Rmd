...
here::i_am("Code/Figures_4_5.Rmd")
...
ggsave(here("Plots", "Fig_4_Combined_Preds_Continuous.pdf"), width = 7.5, height = 9)
ggsave(here("Plots", "Fig_4_Combined_Preds_Continuous.png"), width = 7.5, height = 9)
```
