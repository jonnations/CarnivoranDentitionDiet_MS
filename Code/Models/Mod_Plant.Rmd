...
```{r}
md_RLGA %>% write_rds(file = here("Code/Models/mod_outputs", "plant_md_RLGA.Rds"))
md_ALL %>%  write_rds(file = here("Code/Models/mod_outputs", "plant_md_ALL.Rds"))
md_DNE %>%  write_rds(file = here("Code/Models/mod_outputs", "plant_md_DNE.Rds"))
md_RFI %>%  write_rds(file = here("Code/Models/mod_outputs", "plant_md_RFI.Rds"))
md_OPCR %>%  write_rds(file = here("Code/Models/mod_outputs", "plant_md_OPCR.Rds"))
```
