---
title: "root Prior Predictive Check"
...
Save these models
```{r}
m2 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "root_N21.Rds"))
m8 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "root_S321.Rds"))
m9 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "root_D.Rds"))
```
