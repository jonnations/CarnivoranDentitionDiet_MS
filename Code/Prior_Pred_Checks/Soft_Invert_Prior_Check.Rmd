---
title: "soft_invert Prior Predictive Check"
...
## Normal(1,1), and Student(2,1,2)
Save these models
```{r}
m2 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "soft_invert_N11.Rds"))
m7 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "soft_invert_S212.Rds"))
m9 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "soft_invert_D.Rds"))
```
