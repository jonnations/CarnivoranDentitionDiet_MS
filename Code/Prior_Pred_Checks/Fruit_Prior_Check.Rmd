---
title: "fruit Prior Predictive Check"
...
Save these models
```{r}
m2 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "fruit_N02.Rds"))
m5 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "fruit_S302.Rds"))
m9 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "fruit_D.Rds"))
```
