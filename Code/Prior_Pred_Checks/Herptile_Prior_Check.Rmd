---
title: "herptile Prior Predictive Check"
...
## Normal(0,3), and Student(3,0,3)
Save these models
```{r}
m3 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "herptile_N03.Rds"))
m5 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "herptile_S303.Rds"))
m9 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "herptile_D.Rds"))
```
