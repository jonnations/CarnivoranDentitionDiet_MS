---
title: "carrion Prior Predictive Check"
...
Save these models
```{r}
m2 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "carrion_N12.Rds"))
m6 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "carrion_S322.Rds"))
m9 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "carrion_D.Rds"))
```
