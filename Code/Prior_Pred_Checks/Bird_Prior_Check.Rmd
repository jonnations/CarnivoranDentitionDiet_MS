---
title: "Bird Prior Predictive Check"
...
## Normal(0,2), and Student(3,0,2)
Save these models
```{r}
m2 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "bird_N02.Rds"))
m6 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "bird_S302.Rds"))
m9 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "bird_D.Rds"))
```
