---
title: "plant Prior Predictive Check"
...
Save these models
```{r}
m1 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "plant_N11.Rds"))
m8 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "plant_S311.Rds"))
m9 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "plant_D.Rds"))
```
