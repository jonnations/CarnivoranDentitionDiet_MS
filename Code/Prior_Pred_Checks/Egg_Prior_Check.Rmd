---
title: "egg Prior Predictive Check"
...
Save these models
```{r}
m2 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "egg_N12.Rds"))
m6 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "egg_S322.Rds"))
m9 %>% write_rds(file = here("Code/Prior_Pred_Checks/prior_pred_outputs", "egg_D.Rds"))
```
