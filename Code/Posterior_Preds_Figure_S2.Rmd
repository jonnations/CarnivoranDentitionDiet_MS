...
plot <- wrap_plots(p1, p2,  p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19,
 p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, ncol=6, guides = "collect") + plot_annotation(
...
ggsave(here("Plots", "Figure_S2_Posterior_Pred_Checks.pdf"), width = 20, height = 15, limitsize = FALSE)
```
