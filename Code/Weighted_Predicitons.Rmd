...
expred <- function(mod, weight){
  epred_draws({{mod}}, newdata = dat, ndraws = 1000, probs = c(0.055, 0.945)) %>% 
    as.data.frame() %>% 
...
pred.bird_all <-  expred(readRDS(here("Code/Models/mod_outputs", "bird_md_ALL.Rds")),   bird.w[[2]][[2]])
pred.bird_RFI <-  expred(readRDS(here("Code/Models/mod_outputs", "bird_mn_RFI.rds")),   bird.w[[2]][[3]])

#sum weights
pred.bird <- bind_rows(pred.bird_all, pred.bird_RFI, pred.bird_RLGA) %>% 
#then calculate weighted average (weighted importance score)
  pred(., "bird")
#remove excess dataframes
rm( pred.bird_RFI , pred.bird_RLGA, pred.bird_all )
```
...
```{r}
pred.carrion_RLGA <- expred(readRDS(here("Code/Models/mod_outputs", "carrion_md_RLGA.Rds")), carrion.w[[2]][[1]])
...
```{r}
pred.egg_RFI <- expred(readRDS(here("Code/Models/mod_outputs", "egg_md_RFI.Rds")),   egg.w[[2]][[1]])
pred.egg_DNE <- expred(readRDS(here("Code/Models/mod_outputs", "egg_mn_DNE.Rds")),   egg.w[[2]][[2]])
pred.egg_RLGA <- expred(readRDS(here("Code/Models/mod_outputs", "egg_mn_RLGA.Rds")), egg.w[[2]][[3]])

pred.egg <- bind_rows(pred.egg_DNE, pred.egg_RFI, pred.egg_RLGA) %>% pred(., "egg")

rm( pred.egg_DNE , pred.egg_RFI, pred.egg_RLGA)
```
...
pred.fish_OPCR <- expred(readRDS(here("Code/Models/mod_outputs", "fish_ms_OPCR.Rds")), fish.w[[2]][[2]])

pred.fish <- bind_rows(pred.fish_OPCR, pred.fish_RLGA) %>% pred(., "fish")

rm( pred.fish_OPCR , pred.fish_RLGA)
```
### Fruit
...
```{r}
pred.fruit_OPCR <- expred(readRDS(here("Code/Models/mod_outputs", "fruit_ms_OPCR.Rds")), fruit.w[[2]][[1]])
pred.fruit_RLGA <- expred(readRDS(here("Code/Models/mod_outputs", "fruit_ms_RLGA.Rds")), fruit.w[[2]][[2]])
pred.fruit_RFI <- expred(readRDS(here("Code/Models/mod_outputs", "fruit_mn_RFI.Rds")),   fruit.w[[2]][[3]])

pred.fruit <- bind_rows(pred.fruit_OPCR, pred.fruit_RFI, pred.fruit_RLGA) %>% pred(., "fruit")

rm( pred.fruit_OPCR , pred.fruit_RFI, pred.fruit_RLGA)
```
...
```{r}
pred.hard_invert_ALL <- expred(readRDS(here("Code/Models/mod_outputs", "hard_invert_md_ALL.Rds")),  hard_invert.w[[2]][[1]])
pred.hard_invert_DNE <- expred(readRDS(here("Code/Models/mod_outputs", "hard_invert_mn_DNE.Rds")),  hard_invert.w[[2]][[2]])
pred.hard_invert_RLGA<- expred(readRDS(here("Code/Models/mod_outputs", "hard_invert_md_RLGA.Rds")), hard_invert.w[[2]][[3]])

pred.hard_invert <- bind_rows(pred.hard_invert_ALL, pred.hard_invert_DNE, pred.hard_invert_RLGA) %>% pred(., "hard_invert")

rm(pred.hard_invert_ALL, pred.hard_invert_DNE, pred.hard_invert_RLGA)
```
...
```{r}
pred.herptile_DNE <- expred(readRDS(here("Code/Models/mod_outputs", "herptile_md_DNE.Rds")),   herptile.w[[2]][[1]])
pred.herptile_OPCR <- expred(readRDS(here("Code/Models/mod_outputs", "herptile_md_OPCR.Rds")), herptile.w[[2]][[2]])

pred.herptile <- bind_rows(pred.herptile_OPCR, pred.herptile_DNE) %>% pred(., "herptile")

rm( pred.herptile_OPCR , pred.herptile_DNE)
```
...
```{r}
pred.root_RLGA <- 
  epred_draws(readRDS(here("Code/Models/mod_outputs", "root_mn_RLGA.Rds")), newdata = dat, ndraws = 1000) %>% 
    as.data.frame() %>% 
    select(Species, .draw, .category, .epred) %>% 
    arrange(Species, .draw, .category) %>% 
    pivot_wider(names_from = .category, values_from = .epred) %>% 
...
pred.seed_RLGA <- expred(readRDS(here("Code/Models/mod_outputs", "seed_mn_RLGA.Rds")), seed.w[[2]][[2]])

pred.seed <- bind_rows(pred.seed_DNE, pred.seed_RLGA) %>% pred(., "seed")

rm( pred.seed_DNE , pred.seed_RLGA)
```
...
```{r}
pred.small_mammal_RLGA <- expred(readRDS(here("Code/Models/mod_outputs", "small_mammal_md_RLGA.Rds")), small_mammal.w[[2]][[1]])
...
pred.soft_invert_OPCR <- expred(readRDS(here("Code/Models/mod_outputs", "soft_invert_md_OPCR.Rds")),   soft_invert.w[[2]][[2]])

pred.soft_invert <- bind_rows(pred.soft_invert_DNE, pred.soft_invert_OPCR) %>% pred(., "soft_invert")

rm( pred.soft_invert_DNE , pred.soft_invert_OPCR)
```
...
cpred <- function(mod, weight){
  epred_draws({{mod}}, newdata = cfdat, allow_new_levels = TRUE, ndraws = 1000, probs = c(0.055, 0.945)) %>% 
    as.data.frame() %>% 
    select(Species, .draw, .category, .epred) %>% 
    arrange(Species, .draw, .category) %>% 
    pivot_wider(names_from = .category, values_from = .epred) %>% 
...
pred.bird_all <-  cpred(readRDS(here("Code/Models/mod_outputs", "bird_md_ALL.Rds")),   bird.w[[2]][[2]])
pred.bird_RFI <-  cpred(readRDS(here("Code/Models/mod_outputs", "bird_mn_RFI.rds")),   bird.w[[2]][[3]])

pred.bird <- bind_rows(pred.bird_all, pred.bird_RFI, pred.bird_RLGA) %>% pred(., "bird")
...
```{r}
pred.carrion_RLGA <- cpred(readRDS(here("Code/Models/mod_outputs", "carrion_md_RLGA.Rds")), carrion.w[[2]][[1]])
...
```{r}
pred.egg_RFI <- cpred(readRDS(here("Code/Models/mod_outputs", "egg_md_RFI.Rds")),   egg.w[[2]][[1]])
pred.egg_DNE <- cpred(readRDS(here("Code/Models/mod_outputs", "egg_mn_DNE.Rds")),   egg.w[[2]][[2]])
pred.egg_RLGA <- cpred(readRDS(here("Code/Models/mod_outputs", "egg_mn_RLGA.Rds")), egg.w[[2]][[3]])
...
pred.fish_OPCR <- cpred(readRDS(here("Code/Models/mod_outputs", "fish_ms_OPCR.Rds")), fish.w[[2]][[2]])
...
```{r}
pred.fruit_OPCR <- cpred(readRDS(here("Code/Models/mod_outputs", "fruit_ms_OPCR.Rds")), fruit.w[[2]][[1]])
pred.fruit_RLGA <- cpred(readRDS(here("Code/Models/mod_outputs", "fruit_ms_RLGA.Rds")), fruit.w[[2]][[2]])
pred.fruit_RFI <- cpred(readRDS(here("Code/Models/mod_outputs", "fruit_mn_RFI.Rds")),   fruit.w[[2]][[3]])
...
```{r}
pred.hard_invert_ALL <- cpred(readRDS(here("Code/Models/mod_outputs", "hard_invert_md_ALL.Rds")),  hard_invert.w[[2]][[1]])
pred.hard_invert_DNE <- cpred(readRDS(here("Code/Models/mod_outputs", "hard_invert_mn_DNE.Rds")),  hard_invert.w[[2]][[2]])
pred.hard_invert_RLGA<- cpred(readRDS(here("Code/Models/mod_outputs", "hard_invert_md_RLGA.Rds")), hard_invert.w[[2]][[3]])
...
```{r}
pred.herptile_DNE <- cpred(readRDS(here("Code/Models/mod_outputs", "herptile_md_DNE.Rds")),   herptile.w[[2]][[1]])
pred.herptile_OPCR <- cpred(readRDS(here("Code/Models/mod_outputs", "herptile_md_OPCR.Rds")), herptile.w[[2]][[2]])
...
```{r}
pred.root_RLGA <- 
  epred_draws(readRDS(here("Code/Models/mod_outputs", "root_mn_RLGA.Rds")), newdata = cfdat, allow_new_levels = T, ndraws = 1000) %>% 
    as.data.frame() %>% 
    select(Species, .draw, .category, .epred) %>% 
    arrange(Species, .draw, .category) %>% 
    pivot_wider(names_from = .category, values_from = .epred) %>% 
...
pred.seed_RLGA <- cpred(readRDS(here("Code/Models/mod_outputs", "seed_mn_RLGA.Rds")), seed.w[[2]][[2]])
...
```{r}
pred.small_mammal_RLGA <- cpred(readRDS(here("Code/Models/mod_outputs", "small_mammal_md_RLGA.Rds")), small_mammal.w[[2]][[1]])
...
pred.soft_invert_OPCR <- cpred(readRDS(here("Code/Models/mod_outputs", "soft_invert_md_OPCR.Rds")),   soft_invert.w[[2]][[2]])
