...
```{r}
# Read Tree
phylo <- ape::read.nexus("Data/Carnivora_MCC_2.tre")
...
```{r include=FALSE}
render("Mod_Bird.Rmd") 
render("Mod_Carrion.Rmd")
render("Mod_Egg.Rmd")
render("Mod_Fish.Rmd")
render("Mod_Fruit.Rmd")
render("Mod_Hard_Invert.Rmd")
render("Mod_Herptile.Rmd")
render("Mod_Large_Mammal.Rmd")
render("Mod_Plant.Rmd")
render("Mod_Root.Rmd")
render("Mod_Seed.Rmd")
render("Mod_Small_Mammal.Rmd")
render("Mod_Soft_Invert.Rmd")
```
