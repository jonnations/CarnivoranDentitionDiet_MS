...
r2 <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "carrion_mn_RLGA.Rds")), "Carrion")

r3 <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "fish_ms_RLGA.Rds")), "Fish")

r4 <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "fruit_mn_RLGA.Rds")), "Fruit")

r5 <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "hard_invert_ms_RLGA.Rds")), "Hard Invert")

r6 <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "herptile_md_RLGA.Rds")), "Herptile")

r7 <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "large_mammal_ms_RLGA.Rds")), "Large Mammal")

r8 <- cleanupRLGA2(read_rds(here("Code/Models/mod_outputs", "root_ms_RLGA.Rds")), "Root")

r9 <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "seed_ms_RLGA.Rds")), "Seed")

r10  <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "small_mammal_ms_RLGA.Rds")), "Small Mammal")

r11 <- cleanupRLGA(read_rds(here("Code/Models/mod_outputs", "soft_invert_md_RLGA.Rds")), "Soft Invert")

r12 <- cleanupRFI(read_rds(here("Code/Models/mod_outputs", "egg_mn_RFI.Rds")), "Egg")

r13 <- cleanupRFI(read_rds(here("Code/Models/mod_outputs", "seed_ms_RFI.Rds")), "Seed")

r14 <- cleanupOPCr(read_rds(here("Code/Models/mod_outputs", "carrion_md_OPCR.Rds")), "Carrion")

r15 <- cleanupOPCr(read_rds(here("Code/Models/mod_outputs", "fruit_mn_OPCR.Rds")), "Fruit")

r16 <- cleanupOPCr(read_rds(here("Code/Models/mod_outputs", "plant_md_OPCR.Rds")), "Plant")

r17 <- cleanupaDNE(read_rds(here("Code/Models/mod_outputs", "egg_mn_DNE.Rds")), "Egg")

r18 <- cleanupaDNE(read_rds(here("Code/Models/mod_outputs", "hard_invert_mn_DNE.Rds")), "Hard Invert")

r19 <- cleanupaDNE(read_rds(here("Code/Models/mod_outputs", "herptile_ms_DNE.Rds")), "Herptile")

r20 <- cleanupaDNE(read_rds(here("Code/Models/mod_outputs", "plant_md_DNE.Rds")), "Plant")

r21 <- cleanupaDNE(read_rds(here("Code/Models/mod_outputs", "seed_mn_DNE.Rds")), "Seed")

r22 <- cleanupaDNE(read_rds(here("Code/Models/mod_outputs", "small_mammal_md_DNE.Rds")), "Small Mammal")

r23 <- cleanupaDNE(read_rds(here("Code/Models/mod_outputs", "soft_invert_mn_DNE.Rds")), "Soft Invert")

r24 <- cleanupALL(read_rds(here("Code/Models/mod_outputs", "large_mammal_ms_ALL.Rds")), "Large Mammal")

r25 <- cleanupALL(read_rds(here("Code/Models/mod_outputs", "plant_md_ALL.Rds")), "Plant")

t <- bind_rows(r1, r2, r3, r4, r5, r6, r7, r8 , r9 , r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25)   %>% 
  as_tibble() %>%
